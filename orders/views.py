    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            message = '{}, вы успешно сделали заказ.\
               Номер вашего заказа {}, \
               Страница для управления вашим заказом https://microline.ru/order/{}'.format(order.name, order.id, order.pageid)
...
def OrderPage(request, pageid):
    ...
    SUCCESS_URL = 'http://microline.ru/order/success/'
    FAIL_URL = 'http://microline.ru/order/fail/'
